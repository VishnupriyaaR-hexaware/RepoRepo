...
using DotnetSixApp.Api.Filters;
using DotnetSixApp.BusinessServices.Installer;

namespace DotnetSixApp.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "DotnetSixApp API", Version = version + "-" + branch});
            });
