using DotnetSixApp.Api.Installer;
using DotnetSixApp.Api.Middleware;
using ElmahCore.Mvc;
...
using System;
using DotnetSixApp.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;

namespace DotnetSixApp.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "DotnetSixApp V1");
        });
