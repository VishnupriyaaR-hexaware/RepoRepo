using finalcomp.Api.Installer;
using finalcomp.Api.Middleware;
using ElmahCore.Mvc;
...
using System;
using finalcomp.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;

namespace finalcomp.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "finalcomp V1");
        });
