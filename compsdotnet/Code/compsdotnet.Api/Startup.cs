using compsdotnet.Api.Installer;
using compsdotnet.Api.Middleware;
using ElmahCore.Mvc;
...
using System;
using compsdotnet.Api.OpenTelemetry;
using OpenTelemetry.Trace;
using OpenTelemetry.Exporter;

namespace compsdotnet.Api
{
    public class Startup
{
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
    {
        ...
        app.UseSwaggerUI(c =>
        {
            c.SwaggerEndpoint("/swagger/v1/swagger.json", "compsdotnet V1");
        });
