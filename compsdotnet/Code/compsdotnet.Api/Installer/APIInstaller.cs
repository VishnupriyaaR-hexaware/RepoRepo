...
using compsdotnet.Api.Filters;
using compsdotnet.BusinessServices.Installer;

namespace compsdotnet.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "compsdotnet API", Version = version + "-" + branch});
            });
